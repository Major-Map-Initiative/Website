...
function gen_graph(course, prereqs) {
    ...
    // {"nodes": [ { "course": "shorthand name e.g. CSE 100", "type: "child or parent", "name":"full name e.g. Mathematical Reasoning", "description":"full description" }], "edges": [ { "source": "course1", "target": "course2", "group" : n}, ] }
